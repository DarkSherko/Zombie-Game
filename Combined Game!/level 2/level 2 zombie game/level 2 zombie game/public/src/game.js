...
const game = new Phaser.Game(800, 600, Phaser.AUTO, '', {
  ...
  function create () {
    ...
    enemy = game.add.sprite(250, game.world.height - 305, 'enemy')

    //  We need to enable physics on the enmey
  ...
  function update () {
    ...
    if (score === 120) {
      location.href = 'http://127.0.0.1:5500/Zombie-Game/zovid%20maze/docs/index.html'
    }
  }
  ...
  // Show an alert modal when collision enemy
